    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          role: "model",
          content: locale === "es" 
            ? `Error al conectar con la IA: ${error.message || "Error desconocido"}. Por favor, verifica tu conexión o configuración.`
            : `Error connecting to AI: ${error.message || "Unknown error"}. Please check your configuration.`
        }
      ]);
    } finally {
      setIsLoading(false);
    ...
    <>
      ...
      <AnimatePresence>
        {!isOpen && (
          ...
          >
            <div className="flex items-center gap-3 w-full h-full justify-center sm:justify-start">
